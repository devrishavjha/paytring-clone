...
const values = [{
  ...
  description: "Enterprise-grade security with multi-layered DDoS protection ensuring 99.9% uptime for your payment operations."
}, {
  icon: Unlock,
  title: "Vendor Lock-in Avoidance",
  description: "Freedom to switch payment providers without code changes. Never be tied to a single vendor again."
}, {
  icon: BarChart3,
  title: "Real-time Control & Analytics",
  description: "Comprehensive dashboards with real-time insights into your payment performance and operations."
}];
export function PlatformValue() {
  return <section className="section bg-primary text-primary-foreground">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          once: true
        }} className="text-3xl md:text-4xl lg:text-display-sm font-bold mb-6">
          ...
          delay: 0.1
        }} className="text-primary-foreground/80 text-body-lg max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          delay: 0.1 + index * 0.1
              ...
              <h3 className="text-xl font-semibold mb-3 text-muted">{value.title}</h3>
