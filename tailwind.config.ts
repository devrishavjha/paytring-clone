  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card": "0 2px 8px -2px hsl(214 70% 15% / 0.08), 0 4px 16px -4px hsl(214 70% 15% / 0.12)",
        "card-hover": "0 8px 24px -4px hsl(214 70% 15% / 0.12), 0 16px 40px -8px hsl(214 70% 15% / 0.16)",
        "button": "0 2px 4px hsl(214 70% 15% / 0.12), 0 4px 8px hsl(214 70% 15% / 0.08)",
        "button-hover": "0 4px 8px hsl(214 70% 15% / 0.16), 0 8px 16px hsl(214 70% 15% / 0.12)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
